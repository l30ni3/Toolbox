...
public class ShowAllTools extends AppCompatActivity {
    ...
    private static final String DB_URL = "jdbc:postgresql://10.0.2.2:5432/Werkzeugausleihe";
        ...
        protected String doInBackground(String... strings)  // Connect to the database, write query and add items to array list
        {
            try {
                ...
                if (conn == null) {
                    ...
                    String query = "SELECT * FROM test.table1";
    ...
    public class MyAppAdapter extends BaseAdapter         //has a class viewholder which holds
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) // inflating the layout and initializing widgets
        {
            ...
            if (rowView == null) {
                ...
                viewHolder.listText = (TextView) rowView.findViewById(R.id.listText);
                viewHolder.listImage = (ImageView) rowView.findViewById(R.id.listImage);
                rowView.setTag(viewHolder);
            } else {
                viewHolder = (ViewHolder) convertView.getTag();
            }
            // here setting up names and images
            viewHolder.listText.setText(parkingList.get(position).getName() + "");
            Picasso.with(context).load(parkingList.get(position).getImg()).into(viewHolder.listImage);
